...
io_syscall.o: ${S}/userprog/io_syscall.c
	${COMPILE.c} ${S}/userprog/io_syscall.c
SRCS+=${S}/userprog/io_syscall.c
OBJS+=io_syscall.o

thread_syscall.o: ${S}/userprog/thread_syscall.c
	${COMPILE.c} ${S}/userprog/thread_syscall.c
SRCS+=${S}/userprog/thread_syscall.c
OBJS+=thread_syscall.o

process_helper.o: ${S}/userprog/process_helper.c
	${COMPILE.c} ${S}/userprog/process_helper.c
SRCS+=${S}/userprog/process_helper.c
OBJS+=process_helper.o

vm_helper.o: ${S}/vm/vm_helper.c
	${COMPILE.c} ${S}/vm/vm_helper.c
SRCS+=${S}/vm/vm_helper.c
OBJS+=vm_helper.o
