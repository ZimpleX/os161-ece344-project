...
#define SWAP_FRAME 0xfff00000   /* mask for getting offset in the swap file */
#define PT_MASTER 0xffc00000    /* mask for getting secondary page table entry */
#define PT_SECONDARY 0x003ff000 /* mask for getting actual translation entry */
 ...
 * 0x80000000 + 0x1fffffff = 0x9fffffff --> kseg0
 * kseg0 is "unmapped" --> not mapped by tlb ? --> then how to translate ?
 */
...
/*
 * status is the page status bit in coremap
 * it can be occupied, fixed, or temp_fixed
 */
